    ...
    <div className="h-[835px] min-h-screen p-6">
      <Card className="bg-card-cardCustomBlue p-6">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          >
            <button
              className={`bg-gradient-custom-gradient hover:bg-blue-600 focus:ring-blue-300 rounded-md border border-buttonBorder px-4 py-2 text-white transition-all duration-200 focus:outline-none focus:ring-2 ${
